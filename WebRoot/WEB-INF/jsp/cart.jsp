	...
	<%@ include file="menu.jsp" %>
		...
		<c:choose>
			...
			<div class="step step1">
				...
				<table>
					...
					<tr>
						...
						<tr>
							...
							<td>
								<a href="${ pageContext.request.contextPath }/cart/removeCart.do?pid=${c.product.pid}" class="delete">删除</a>
							</td>
						</tr>
						</c:forEach>
					</tbody>
				...
				<div class="bottom">
					<a href="${ pageContext.request.contextPath }/cart/clearCart.do" id="clear" class="clear">清空购物车</a>
