		...
		<div class="span18 last">
			...
			<div class="info">
				<dl>
					<dt>商城价:</dt>
					<dd>
						<strong>￥：${c.shop_price}元</strong>
							参 考 价：
							<del>￥${c.market_price}元</del>
					</dd>
				</dl>
					<dl>
						<dt>促销:</dt>
			...
			<form id="cartForm" action="${ pageContext.request.contextPath }/cart/addCart.do" method="post" >
